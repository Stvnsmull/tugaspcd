...
img = cv2.imread("bndito.jpg") #melakukan pembacaan gambar yang berada satu folder 
...
for y in range(0, img_height): #memberikan interval range untuk y
...
#menampilkan histogram komulatif
